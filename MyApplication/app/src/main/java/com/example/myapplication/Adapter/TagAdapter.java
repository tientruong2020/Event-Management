...
public class TagAdapter extends RecyclerView.Adapter<com.example.myapplication.Adapter.TagAdapter.ViewHolder>{
...
//
        return new com.example.myapplication.Adapter.TagAdapter.ViewHolder(view);
    }
